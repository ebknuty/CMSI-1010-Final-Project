...
menu_background = pygame.transform.scale(pygame.image.load("CMSI-1010-Final-Project/Premium_top-down_shooter_asset_pack/yo gurt.jpg"), (1000,1000))

play_button_img = pygame.transform.scale(
    pygame.image.load("CMSI-1010-Final-Project/Premium_top-down_shooter_asset_pack/Play Rect.png"),
    (400, 125)
)
quit_button_img = pygame.transform.scale(
    pygame.image.load("CMSI-1010-Final-Project/Premium_top-down_shooter_asset_pack/Quit Rect.png"),
    (400, 125)
)
...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.image = pygame.transform.rotozoom(
            pygame.image.load(
                "CMSI-1010-Final-Project/Premium_top-down_shooter_asset_pack/Player with AK.png"
            ).convert_alpha(),
            0, player_size
        )
...
def main_menu():
    ...
    play_button = Menu(
        ...
        (500, 600),
        pygame.font.Font(
            "CMSI-1010-Final-Project/Premium_top-down_shooter_asset_pack/font.ttf", 100
        ),
        "PLAY"
    )
    ...
    title_display = Menu(title_surface,
        (500,70) ,
        pygame.font.Font(
            "CMSI-1010-Final-Project/Premium_top-down_shooter_asset_pack/font.ttf", 60
        ),
        "Welcome to Pest!"
    )
    menu_active = True

...
background = pygame.transform.scale(
    pygame.image.load("Lords Of Pain/environment/ground.png").convert(),  # EDIT: removed duplicate .png
...
while game_running:
    ...
    handle_player_input(player, bullet_group)  # EDIT: handle shooting & reload events
    ...
    display.blit(crosshair, (cursor[0] - crosshair.get_width()//2,
